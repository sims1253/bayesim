...
bayesim::density_lookup_generator(n_x=n_x, mu_int=unit_int, shape_int=shape_int, x_int_prelink=unit_int,
...
bayesim::density_lookup_generator(n_x=n_x, mu_int=unit_int, shape_int=shape_int, x_int_prelink=pos_int, x_link=exp,
